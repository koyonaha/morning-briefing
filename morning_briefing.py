...
def main():
    ...
    try:
        ...
        # BRIEFING_TYPE is set by GitHub Actions workflow - single source of truth
        # No hour check needed - GitHub Actions schedule handles timing
        if briefing_type == 'morning':
            ...
            logger.info("No valid BRIEFING_TYPE set. Exiting.")
            return
